...
import { Share2, Twitter, Facebook, MessageCircle, Link2, Check, Copy } from 'lucide-react'
...
export function ShareButton({
  ...
  const handleShare = (platform: keyof typeof shareUrls) => {
    if (platform === 'discord') {
      ...
      toast.success(`Sharing to ${platform.charAt(0).toUpperCase() + platform.slice(1)}...`, 'Shared')
    }
    setShowMenu(false)
  }
