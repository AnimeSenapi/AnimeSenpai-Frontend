 ...
 * 🎨 THEME CONFIGURATION
 * 
 * This is the ONLY file you need to edit to change the app's theme!
 * 
 * How to use:
 * 1. Edit the colors in 'activeTheme' below
 * 2. Or switch to a different theme by changing 'ACTIVE_THEME'
 * 3. Or create a new theme and set it as active
 */
...
export const ACTIVE_THEME = 'cyberpunk' // Options: 'darkwave', 'cyberpunk', or your custom theme name
...
export interface Theme {
  ...
  colors: {
    ...
    error: { 400: string; 500: string; 600: string }
    warning: { 400: string; 500: string; 600: string }
    info: { 400: string; 500: string; 600: string }
    planning: { 400: string; 500: string; 600: string }
...
// ============================================
// 🎨 THEME 1: DarkWave UI (Default)
// ============================================

export const darkWaveTheme: Theme = {
  name: 'darkwave',
  displayName: 'DarkWave UI',
  description: 'OLED-optimized dark theme with vibrant accents',
  colors: {
    // Brand Colors
    primary: {
      400: '#4fd1ff',
    ...
    gray: {
      300: '#d1d5db',  // Light gray (for light text)
...
export const cyberpunkTheme: Theme = {
  ...
  description: 'Original cyberpunk theme with cyan and pink neon',
  colors: {
    // Brand Colors
    primary: {
      400: '#22d3ee',
...
// Uncomment and edit this template to create your own theme:
/*
export const myCustomTheme: Theme = {
  ...
  colors: {
    // Copy the structure from darkWaveTheme above
    primary: {
      400: '#YOUR_COLOR',
      500: '#YOUR_COLOR',
      600: '#YOUR_COLOR',
...
export const activeTheme = themes[ACTIVE_THEME] || darkWaveTheme
export const defaultTheme = activeTheme
