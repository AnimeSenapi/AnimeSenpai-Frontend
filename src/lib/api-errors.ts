...
function getErrorMessage(code: string, defaultMessage: string): string {
  const errorMessages: Record<string, string> = {
    ...
    'EMAIL_NOT_VERIFIED': 'Please verify your email address to continue. Check your inbox for the verification link.',
    'PASSWORD_TOO_WEAK': 'Password is too weak. Please use a stronger password with at least 8 characters, including uppercase, lowercase, numbers, and special characters.',
    ...
    'INVALID_USERNAME': 'Username must be 2-50 characters and can only contain letters, numbers, underscores, and hyphens.',
    ...
    'USER_PROFILE_NOT_FOUND': 'User profile not found. The user may have deleted their account or changed their username.',
    ...
    // Server errors
    'INTERNAL_SERVER_ERROR': 'Something went wrong on our end. Our team has been notified. Please try again later.',
    'SERVICE_UNAVAILABLE': 'Service is temporarily unavailable. We\'re working on it. Please try again in a few minutes.',
    ...
    'CONNECTION_REFUSED': 'Unable to connect to server. Please check if the server is running and try again.',
    'OFFLINE': 'You appear to be offline. Please check your internet connection.',
    'DNS_ERROR': 'Unable to resolve server address. Please check your internet connection.',
    
    // File upload errors
    'FILE_TOO_LARGE': 'File is too large. Maximum size is 2MB. Please compress your image or choose a smaller file.',
