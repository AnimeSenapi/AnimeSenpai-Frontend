              ...
              <div className="space-y-8">
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 leading-relaxed">
                        AnimeSenpai is a community-driven platform for discovering, discussing, and
                        recommending anime. You can browse anime recommendations, follow other
                        users, and participate in community features such as posts, comments, and
                        chats (some of which may be introduced in future updates).
                      </p>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 leading-relaxed mb-4">
                        You must be at least <strong className="text-white">13 years old</strong> to
                        use AnimeSenpai. If you are under the age of 18, you must have the consent
                        of a parent or guardian to use the Service.
                      </p>
                      <p className="text-gray-300 leading-relaxed mb-3">
                        By using AnimeSenpai, you confirm that:
                      </p>
                      <div className="space-y-2">
                        <div className="flex items-start gap-3">
                          <div className="w-1.5 h-1.5 rounded-full bg-primary-400 mt-2 flex-shrink-0"></div>
                          <p className="text-gray-300 text-sm">
                            You can form a legally binding agreement in your country of residence
                          </p>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-1.5 h-1.5 rounded-full bg-primary-400 mt-2 flex-shrink-0"></div>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 leading-relaxed mb-3">
                        To access certain features, you must create an AnimeSenpai account. You
                        agree to:
                      </p>
                      <div className="space-y-2">
                        <div className="flex items-start gap-3">
                      ...
                      <p className="text-gray-300 leading-relaxed mt-4">
                        ...
                        Terms or are used in ways that harm the community.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h2 className="text-xl font-bold text-white mb-3">4. Community Conduct</h2>
                      <p className="text-gray-300 leading-relaxed mb-4">
                        AnimeSenpai is built around respect, positivity, and a shared love for
                        anime. To maintain a safe environment, you agree not to:
                      </p>
                      <div className="space-y-2">
                        <div className="flex items-start gap-3">
                          <XCircle className="h-4 w-4 text-warning-400 mt-0.5 flex-shrink-0" />
                          <p className="text-gray-300 text-sm">
                            Post or share any content that is illegal, discriminatory, explicit, or
                            otherwise harmful
                          </p>
                        </div>
                        <div className="flex items-start gap-3">
                        ...
                        <div className="flex items-start gap-3">
                          <XCircle className="h-4 w-4 text-warning-400 mt-0.5 flex-shrink-0" />
                          <p className="text-gray-300 text-sm">
                            Use AnimeSenpai for commercial spam or self-promotion
                          </p>
                        </div>
                        <div className="flex items-start gap-3">
                          <XCircle className="h-4 w-4 text-warning-400 mt-0.5 flex-shrink-0" />
                      ...
                      <p className="text-gray-300 leading-relaxed mt-4">
                        We may remove or moderate content that violates these guidelines at our
                        discretion.
                      </p>
                    </div>
                  </div>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 leading-relaxed mb-3">
                        You own the content you create or share on AnimeSenpai ("User Content"). By
                        posting or uploading content, you grant AnimeSenpai a{' '}
                        <strong className="text-white">
                          non-exclusive, worldwide, royalty-free license
                        </strong>{' '}
                        to host, display, and distribute your content as necessary to operate and
                        promote the Service.
                      </p>
                      <p className="text-gray-300 leading-relaxed mb-4">
                        You can delete your content at any time. However, copies of your content may
                        remain in backup systems for a limited period.
                      </p>
                      <h3 className="text-base font-semibold text-white mb-2">Our Rights</h3>
                      <p className="text-gray-300 leading-relaxed">
                        All other materials on AnimeSenpai (including design, code, logo, and
                        branding) are owned or licensed by AnimeSenpai and protected under
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      <h2 className="text-xl font-bold text-white mb-3">6. Privacy and Data</h2>
                      <p className="text-gray-300 leading-relaxed mb-3">
                        AnimeSenpai collects limited user data such as account information,
                        preferences, and analytics to operate and improve the Service.
                      </p>
                      <p className="text-gray-300 leading-relaxed mb-3">
                        By using AnimeSenpai, you consent to our data collection and processing
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 leading-relaxed mb-3">
                        AnimeSenpai is currently <strong className="text-white">free to use</strong>
                        . In the future, we may introduce optional premium features or support
                        options to help maintain and improve the Service.
                      </p>
                      <p className="text-gray-300 leading-relaxed">
                        If we introduce paid services, we will clearly explain the pricing, billing,
                        and refund policies at that time.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 leading-relaxed mb-3">
                        We are continuously improving AnimeSenpai. We may update, change, or
                        temporarily suspend parts of the Service from time to time.
                      </p>
                      <p className="text-gray-300 leading-relaxed">
                        We are not liable for any downtime, loss of data, or other issues resulting
                        from maintenance or updates — though we'll always aim to keep the community
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 leading-relaxed mt-4">
                        Upon termination, you lose access to your account and its content. Some
                        obligations (like intellectual property rights and limitations of liability)
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 leading-relaxed mb-3">
                        AnimeSenpai is provided <strong className="text-white">"as is"</strong>{' '}
                        without warranties of any kind, express or implied. We do not guarantee
                        uninterrupted service, accuracy of recommendations, or the availability of
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 leading-relaxed mb-3">
                        To the maximum extent permitted by law, AnimeSenpai (and its individual
                        operator) will not be liable for:
                      </p>
                      <div className="space-y-2">
                        <div className="flex items-start gap-3">
                          <div className="w-1.5 h-1.5 rounded-full bg-primary-400 mt-2 flex-shrink-0"></div>
                        ...
                        <div className="flex items-start gap-3">
                          <div className="w-1.5 h-1.5 rounded-full bg-primary-400 mt-2 flex-shrink-0"></div>
                          <p className="text-gray-300 text-sm">
                            Loss of data, reputation, or profits
                          </p>
                        </div>
                        <div className="flex items-start gap-3">
                          <div className="w-1.5 h-1.5 rounded-full bg-primary-400 mt-2 flex-shrink-0"></div>
                      ...
                      <p className="text-gray-300 leading-relaxed mt-3 text-sm">
                        Some jurisdictions do not allow such limitations, so parts of this section
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 leading-relaxed">
                        ...
                        <strong className="text-white">Denmark</strong>, without regard to
                        conflict-of-law principles. You agree to submit to the exclusive
                        jurisdiction of the courts located in Denmark for any dispute arising under
                        these Terms.
                      </p>
                    </div>
                  </div>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-300 leading-relaxed mb-3">
                        We may update these Terms periodically to reflect changes in our features or
                        legal obligations. When we make significant updates, we will post a notice
                        on our website or notify you via your account.
                      </p>
                      <p className="text-gray-300 leading-relaxed">
                        The continued use of AnimeSenpai after changes means you accept the revised
                        Terms.
                      </p>
                    </div>
                  </div>
                ...
                >
                  <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1">
                      ...
                      <a
                        href="mailto:legal@animesenpai.app"
                ...
                <div className="bg-gradient-to-r from-primary-500/10 to-secondary-500/10 border border-primary-500/20 rounded-xl p-6 text-center">
                  ...
                  <p className="text-gray-300 text-sm">
                    Together, we're building a respectful, passionate, and creative space for anime
