    ...
    async function loadProfile() {
      try {
        ...
        const [statsRes, animeListRes, socialRes] = await Promise.all([
          ...
          fetch(`${API_URL}/user.getAnimeList?input=${encodeURIComponent(JSON.stringify({ limit: 20 }))}`, {
            method: 'GET',
            headers: getAuthHeaders()
          }),
          user?.id ? fetch(`${API_URL}/social.getSocialCounts?input=${encodeURIComponent(JSON.stringify({ userId: user.id }))}`, {
            method: 'GET',
            headers: getAuthHeaders()
          }) : null
        ])
            ...
            <div className="glass rounded-2xl p-6">
                ...
                {recentAnime.length === 0 ? (
                  <div className="text-center py-12">
                    ...
                    <p className="text-gray-500 text-sm mb-4">Start watching anime to see your activity here</p>
                    <Link href="/search">
