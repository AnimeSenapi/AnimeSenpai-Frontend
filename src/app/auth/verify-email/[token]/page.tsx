...
import { CheckCircle, AlertCircle, ArrowLeft, Loader2, Sparkles } from 'lucide-react'
        ...
        <div className="glass rounded-3xl p-6 sm:p-8 md:p-12 text-center shadow-2xl border border-white/10">
          ...
          <div className="bg-primary-500/10 border border-primary-500/20 rounded-xl p-4 mb-6">
            <div className="flex items-center justify-center gap-2 text-primary-300">
              ...
              <p className="text-sm">
                Redirecting to {isAuthenticated ? 'dashboard' : 'sign in'} in{' '}
                <span className="font-bold text-primary-400">{countdown}s</span>
              </p>
            </div>
          </div>
